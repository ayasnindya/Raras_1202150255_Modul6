...
public class PostFoto extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        gambardiupload = (ImageView) findViewById(R.id.upload);
        title = (EditText) findViewById(R.id.judul);
    ...
    public void uploadingambar(View view) {
        ...
        task.addOnSuccessListener(new OnSuccessListener<UploadTask.TaskSnapshot>() {
            ...
            public void onSuccess(UploadTask.TaskSnapshot taskSnapshot) {
                ...
                dataref.push().setValue(user).addOnSuccessListener(new OnSuccessListener<Void>() {
                    ...
                    public void onSuccess(Void aVoid) {
                        Toast.makeText(PostFoto.this, "Post uploaded", Toast.LENGTH_SHORT).show();
                        finish();
                    }
                    ...
                    public void onFailure(@NonNull Exception e) {
                        Toast.makeText(PostFoto.this, e.getMessage(), Toast.LENGTH_SHORT).show();
                    }
                });
            ...
            @Override
            public void onFailure(@NonNull Exception e) {
                Toast.makeText(PostFoto.this, "Upload Failure!", Toast.LENGTH_SHORT).show();
                dlg.dismiss();
            }
        });
